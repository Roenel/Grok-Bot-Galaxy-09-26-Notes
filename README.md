...
| Order | File | Why |
|------:|------|-----|
| 1 | [`TIMELINE.md`](TIMELINE.md) | Chronological spine: times, segments, coverage status, note/shot pointers |
| 2 | [`TAKEAWAYS.md`](TAKEAWAYS.md) | Stealable lessons by theme (no fabrications) |
...
- Event notes only — no API keys, tokens, `.env`, private keys, or Tailscale / internal IPs
- GitHub secret scanning + push protection are on
- Outside PR creation is restricted by the owner
- Wiki is disabled
