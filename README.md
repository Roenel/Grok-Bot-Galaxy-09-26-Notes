...
| **3** | Sept 17 | [X broadcast](https://x.com/i/broadcasts/1YGNrbXEeazGw) — **complete through player 07:58:23 (end card)**; [`TIMELINE-day3.md`](TIMELINE-day3.md) |
...
| Order | File | Why |
|------:|------|-----|
| 1 | [`TIMELINE.md`](TIMELINE.md) / [`TIMELINE-day2.md`](TIMELINE-day2.md) | Day 1 / Day 2 chronological spines |
| 2 | [`TAKEAWAYS.md`](TAKEAWAYS.md) | Day 1 stealable lessons |
| 3 | [`notes/INDEX.md`](notes/INDEX.md) + note files | Depth per segment |
| — | [`AGENTS.md`](AGENTS.md) | Machine-oriented nav / conventions |
| — | [`shots/INDEX.md`](shots/INDEX.md) | Curated screenshots |

## Day 1 coverage map

| Window (ET) | Approx PT | Status | What you get |
|-------------|-----------|--------|--------------|
| ~11:30 AM → **~3:08 PM** | ~8:30 AM → ~12:08 PM | **`replay-backfill`** | [`notes/backfill-morning.md`](notes/backfill-morning.md) + `shots/backfill/bf_*.png` — slide-first; no CC |
| **~3:08 PM** → ~8:22 PM | ~12:08 PM → ~5:22 PM | **`live`** (Q&A = **`visual-only`**) | Eng → builders → PM → Founders → Q&A scenes → end |
...
notes/               — Day 1 logs + NOTES.md
notes/day2/          — Day 2 remainder packs
shots/               — Day 1 screenshots (+ backfill/)
