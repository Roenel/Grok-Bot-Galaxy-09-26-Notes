# Day 1 timeline — Grok Bot Galaxy (Sept 15, 2026)

**Broadcast:** https://x.com/i/broadcasts/1AxRnZbVpjaxl  
**Zones:** ET = America/New_York · **PT = ET−3**  
**Stream:** scheduled ~8:30 AM–6:00 PM PT; **actual end ~8:22 PM ET** (~8h45m player time).
...
| ~17:30 | ~14:30 | BRB → **PM** start | Transition | `live` | [eng-remainder7](notes/eng-remainder7.md), [eng-remainder8](notes/eng-remainder8.md) | `eng-remainder7-1730-brb.png`, `pm-agents-as-colleagues.png` |
| 17:30–18:30 *(sched.)* | 14:30–15:30 | **PM** | Kevin Niparko — Grok Bot for PMs | `live` | [pm-remainder1](notes/pm-remainder1.md)–[3](notes/pm-remainder3.md); NOTES PM sections | `pm-002-pm-use-cases.png`, `pm-006-why-many-agents.png`, `pm-012-prd-….png`, `pm-455.png` (Lessons) |
| ~18:10–18:30 | ~15:10–15:30 | Post-PM BRB / CTA / panel | Challenge CTA; on-stage panel | `live` | [pm-remainder2](notes/pm-remainder2.md), [pm-remainder3](notes/pm-remainder3.md) | `pm-575.png`, `pm-635.png`, `pm-remainder3-brb-start.png` |
| ~18:30–19:00 | ~15:30–16:00 | Builders — art exhibition / wireframes / merch | Builders table (tidraw, Soft Blob, etc.) | `live` | [founders-remainder1](notes/founders-remainder1.md), [founders-remainder2](notes/founders-remainder2.md) | `2026-09-15_1838-builders-tidraw.png`, `2026-09-15_1842-builders-tidraw-wireframes.png`, `2026-09-15_1850-builders-plush-variants.png` |
| **19:00–~19:35** | **16:00–~16:35** | **Founders** | Shub Gaur — deck, demos (Close/Prod/Stalk/Proto), tips | `live` | [founders-remainder3](notes/founders-remainder3.md)–[5](notes/founders-remainder5.md) | `2026-09-15_1901_founders-agenda.png`, `…_founders_01_close-bot-….png`, `…_1931_recap-what-we-learned.png`, `…_1934_rapid-fire-tips-1.png` |
| ~19:36–20:22 | ~16:36–… | **Q&A** → stream end | Presenter → roundtable → split-screen | `live` / **`visual-only`** | [founders-remainder5](notes/founders-remainder5.md)–[8](notes/founders-remainder8.md); NOTES end | `…_1936_qna-presenter.png`, `…_1954ET_founders-qa-roundtable.png`, `2026-09-15T2022ET-stream-end-card.png` |
...
- **Q&A:** Thank-you ~19:35 → on-camera Q&A with **no readable questions/answers**. Do **not** invent substance.
